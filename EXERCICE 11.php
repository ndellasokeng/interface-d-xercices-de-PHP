...
<body>
  ...
  // Tableau associatif de l'exercice 8
    ...
    // Affichage des informations avec une boucle while pour l'exercice 8
    echo "=== Informations de l'exercice 8 ===\n";
    $keysExercice8 = array_keys($personnesExercice8);
    
    while (list($nom, $infos) = each($personnesExercice8)) {
        echo "Nom: $nom\n";
    ...
    // Réinitialisation du pointeur de tableau pour la boucle suivante
    ...
    while (list($nom, $infos) = each($personnesExercice9)) {
        echo "Nom: $nom\n";
        echo "Prénom: {$infos['prenom']}\n";
        echo "Ville: {$infos['ville']}\n";
        echo "Âge: {$infos['age']}\n";
