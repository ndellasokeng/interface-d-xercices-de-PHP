...
<body>
    ...
    <h3> EXERCICE 16 </h3>
    <?php
function calculerSinus($mesure, $unite = 'radian') {
    // Convertir l'angle en radian si nécessaire
    switch ($unite) {
        case 'degre':
            $angleEnRadian = deg2rad($mesure);
            break;
        case 'grade':
            $angleEnRadian = ($mesure / 200) * M_PI;
            break;
        case 'radian':
        default:
            $angleEnRadian = $mesure;
            break;
    }

    // Calculer le sinus de l'angle en radian
...
$angleEnRadian = calculerSinus(1.5708); // Par défaut, mesure en radian
$angleEnDegre = calculerSinus(90, 'degre');
$angleEnGrade = calculerSinus(100, 'grade');

echo "Sinus de 1.5708 radian : $angleEnRadian<br>";
echo "Sinus de 90 degrés : $angleEnDegre<br>";
echo "Sinus de 100 grades : $angleEnGrade<br>";
?>
</body>
</html>